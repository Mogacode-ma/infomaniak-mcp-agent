...
const lines = [
  "",
  `  ${c.dim}─────────────────────────────────────────────────────────${c.reset}`,
  `  Thanks for installing ${c.cyan}infomaniak-mcp-agent${c.reset}.`,
  "",
  `  I hope it saves you time driving your Infomaniak account`,
  ...
  "",
  `  A ${c.yellow}⭐${c.reset} helps other Infomaniak devs find this. A drive-by`,
  `  "hello" in Discussions is just as welcome.`,
  "",
